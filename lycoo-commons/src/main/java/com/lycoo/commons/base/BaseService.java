...
//     * @param random_number         随机字符串16位
//     * @param machine_code          mac地址
//     * @param sign                 通过签名算法计算得出的签名值(大写32位)
//     * @return                     是否需要开机状态信息
//     *
//     * Created by mono on 2023/4/10
//     */
//    @POST("EquipmentRightControl")
//    @FormUrlEncoded
//    Call<BootInfoResponse> getBootInfo(@Field("timestamp") int timestamp,
//                                       @Field("random_number") String random_number,
...
//     * Created by mono on 2023/4/10
//     */
//    @POST("MachineWCQRCode")
//    @FormUrlEncoded
//    Call<QRCodeResponse> getQRCode(@Field("timestamp") int timestamp,
//                                         @Field("random_number") String random_number,
//                                         @Field("machine_code") String machine_code,
//                                         @Field("sign") String sign);
